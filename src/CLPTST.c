...
int main(int argc, char * argv[])
{
   ...
   if (pfPar!=NULL) {
      ...
      fclose(pfPar);
      acBuf[l]=EOS;
      pvHdl=pvClpOpen(FALSE,TRUE,TRUE,1,"limes","CLPTST","MAIN","man-page","help-msg",FALSE,asMainArgTab,&stMain,stderr,stderr,NULL,NULL,NULL,NULL,"-->","/",",",NULL,NULL,NULL,NULL,NULL,NULL);
      if (pvHdl!=NULL) {
