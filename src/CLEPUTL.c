   ...
   const unsigned int   len)
{
   ...
   for (i=0;i<len;i++) {
      switch (chr[i]) {
         ...
         case C_EXC: asc[i]=0x5A; break;
         case '\"' : asc[i]=0x7F; break;
         case C_HSH: asc[i]=0x7B; break;
         case C_DLR: asc[i]=0x5B; break;
         ...
         case C_SBO: asc[i]=0x00; break;
         case C_BSL: asc[i]=0xE0; break;
         case C_SBC: asc[i]=0x00; break;
         case C_CRT: asc[i]=0x5F; break;
         case '_'  : asc[i]=0x6D; break;

         case C_GRV: asc[i]=0x79; break;
         ...
         case C_CBO: asc[i]=0xC0; break;
         case C_VBR: asc[i]=0x4F; break;
         case C_CBC: asc[i]=0xD0; break;
         case C_TLD: asc[i]=0xA1; break;
