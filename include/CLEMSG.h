...
static const char* SYN_CLE_CHGPROP ="CHGPROP command property_list # root (owner.program.command) is prefixed #";
...
static const char* SYN_CLE_GETPROP ="GETPROP [command[.path] [DEPTH1 | ... | DEPTH9 | DEPALL | ALL]]";
...
static const char* HLP_CLE_CONFIG  ="Shows or clear all the current configuration settings";
static const char* SYN_CLE_CONFIG  ="CONFIG [CLEAR]";
